...
public:
	...
	virtual void pin_mode(int pinNum, WiringPinMode mode) { pinMode(pinNum, mode); }
	virtual void pin_write(int pinNum, boolean level) { digitalWrite(pinNum, level); }
	virtual int  pin_read(int pinNum) { return digitalRead(pinNum); }
